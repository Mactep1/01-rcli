...
pub enum TextSubCommand {
    #[command(about = "Sign a text message with a private key and output the signature")]
    Sign(TextSignEncodeOpts),
    #[command(about = "Verify a text message with a public key and signature")]
